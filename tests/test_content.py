...
def test_output_content1():
  cwd = os.getcwd()
  ansfile1 = cwd + "/answer/exec_to-do.c"
  f = open(ansfile1)
  ans1_content = f.read()
  f.close()
...
def test_output_content2():
  cwd = os.getcwd()
  ansfile2 = cwd + "/answer/exec_to-do.c"
  f = open(ansfile2)
  ans2_content = f.read()
  f.close()
...
def test_output_content3():
  cwd = os.getcwd()
  ansfile3 = cwd + "/answer/exec_to-do.c"
  f = open(ansfile3)
  ans3_content = f.read()
  f.close()
...
def test_output_content6():
  cwd = os.getcwd()
  ansfile6 = cwd + "/answer/pc_pid.c"
  f = open(ansfile6)
  ans6_content = f.read()
  f.close()

  substring = "Child Process"
